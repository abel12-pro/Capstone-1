...
1. Go to this URL link: https://github.com/abel12-pro/Capstone-1
...
```sh
  cd my-folder
  git clone https://github.com/abel12-pro/Capstone-1
```
...
Feel free to check the [issues page](https://github.com/abel12-pro/Capstone-1/issues).
